...
/**
 * AdminDashboard
 * Dashboard administrativo isolado que não deve afetar outros componentes.
 * Todos os estilos são scoped para este componente apenas.
 */
...
const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex h-screen bg-black/95">
      {/* Admin Sidebar */}
